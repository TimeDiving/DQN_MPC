...
if __name__ == "__main__":
    ...
    while True:
        ...
        if state_schedule != 0:
            ...
            #cluster_link_number = 1
            #train_ticks = cluster_link_number
            #hot_node_work_load = hot_node_period * train_ticks
            #communication_deadline_lengh = (hot_node_work_load / communication_speed) * 4
